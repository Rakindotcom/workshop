    ...
    <>
      ...
      <section id="registration" className="cool-form py-12 px-4 relative">
        ...
        <div className="text-center mb-8">
          ...
          <p className="font-anek text-red-700 rounded-2xl py-3 bg-white text-xl mb-4">আসন সীমিত! আজই নিশ্চিত করুন আপনার স্থান</p>
          ...
          <div className="glass-card inline-flex items-center px-4 py-2 rounded-lg pulse-glow">
            ...
            <span className="ml-2 bg-white/20 px-2 py-1 rounded text-white text-2xl">সাধারণ মূল্য: ১৫০০ টাকা</span>
          </div>
        </div>

        {/* Payment Information Section */}
        <div className="mb-8">
          <div className="glass-card rounded-xl p-8 border-2 border-gradient-to-r from-yellow-400/50 to-orange-400/50 relative overflow-hidden">
            ...
            <div className="relative z-10">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            {copiedText === 'mobile' && (
                              <span className="text-green-300 text-sm font-bold animate-pulse">কপি হয়েছে!</span>
                            )}
                          </div>
                        </div>
                        <div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            {copiedText === 'account' && (
                              <span className="text-blue-300 text-sm font-bold animate-pulse">কপি হয়েছে!</span>
                            )}
                          </div>
                        </div>
                        <div>
              ...
              <div className="mt-8 text-center">
                <div className="glass-card inline-block px-6 py-4 rounded-full border-2 border-yellow-400/50">
                  <p className="text-yellow-300 text-2xl mt-1 animate-pulse">
                ...
                <div className={`p-4 glass-card rounded-lg ${errors.paymentConfirmed ? 'border-red-400/50' : ''
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-anek text-yellow-300 text-[22px] mt-1 animate-pulse">
